...
**点数消耗规则**
- 资料检索与资料整理两个阶段合计消耗 3 点
- 用户可选择跳过资料检索和资料整理,直接进入文章结构生成阶段
- 跳过时系统提示:若不是学术性论文,可不做资料检索和整理,直接生成文章结构
- 用户选择跳过后,不消耗点数,直接进入阶段 5 文章结构生成
...
- 用户点击跳过按钮后,直接跳转至文章结构生成页面,不消耗点数

#### 阶段 4:资料整理

**点数消耗规则**
- 资料检索与资料整理两个阶段合计消耗 3 点
- 仅当用户完成资料整理并确认进入下一步时,才扣除 3 点
- 若用户在资料检索阶段选择跳过,则不进入资料整理阶段,不消耗点数
...
13. 用户点击确认并进入下一步后,扣除 3 点(资料检索与资料整理合计消耗)
...
- 点击后保存用户决策,扣除 3 点,调用 generate-article-structure 接口,进入文章结构生成页面
...
- 用户可在资料检索阶段选择跳过,直接进入文章结构生成,不消耗点数

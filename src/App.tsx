...
import MaterialsPage from './pages/MaterialsPageEnhanced';
import ReferencesPage from './pages/ReferencesPageEnhanced';
import TemplatesPage from './pages/TemplatesPageEnhanced';
